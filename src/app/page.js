 ...
 const projects = [
  {
    ...
    github: "https://github.com/MuhammadAsad878/homeease",
  ...
  },
  {
    ...
    github: "https://github.com/MuhammadAsad878/giftlink",
  ...
  },
  {
    ...
    github: "https://github.com/MuhammadAsad878/chat-app",
  ...
  },
  {
    ...
    features: ["Role-based Access", "Image Storage", "CRUD Operations", "Admin Dashboard"],
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div className="flex flex-wrap gap-2">
          {["Reactjs", "Node.js", "Express.js", "Django", ".Net Winforms", "Passport.js"].map((skill, index) => (
